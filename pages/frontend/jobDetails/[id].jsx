                ...
                <div className="flex w-full px-8 md:px-20 items-start md:flex-row flex-col md:justify-between justify-center">
                  ...
                  <div className="md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
                    <div className="flex items-center justify-center mb-1">
                      ...
                      <p className=" text-sm text-gray-800 mx-1">Jaipur</p>
                    </div>
                    <div className="flex items-center justify-center mb-1">
                      ...
                      return (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="mx-6 my-2 py-2 px-4  border border-indigo-600 uppercase  rounded flex items-center justify-center transition-all duration-700 hover:bg-slate-700 hover:text-white text-indigo-600 font-semibold"
                          >
                            View Detail
